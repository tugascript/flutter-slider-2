...
import '../../../components/sizes/game/game_info_button_sizes.dart';
...
class TimerButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sizes = GameInfoButtonSizes.getGameInfoButtonSize(width);
...
class _TimerButtonViewModel {
  ...
  factory _TimerButtonViewModel.fromStore(Store<AppState> store) {
    final isPaused = selectPuzzleState(store).status == GameStatusEnum.paused;
